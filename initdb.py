...
def initdb():
    ...
    screensaver = get_or_create_phrase(name='Screensaver', display_name='NewScreensavers')
    quest_progress = get_or_create_phrase(name='QuestLog', display_name='QuestProgress')
    congressional_vote = get_or_create_phrase(name='CongressVote', display_name='CongressVotes')

    lucas_first_names = get_or_create_component_type(name='LucasFirstName', phrase_id=lucas_name.id)
    lucas_last_names = get_or_create_component_type(name='LucasLastName', phrase_id=lucas_name.id)
    prince_prefixes = get_or_create_component_type(name='PrincePrefix', phrase_id=prince_song.id)
    prince_adjectives = get_or_create_component_type(name='PrinceAdjective', phrase_id=prince_song.id)
    prince_nouns = get_or_create_component_type(name='PrinceNoun', phrase_id=prince_song.id)
    prince_suffixes = get_or_create_component_type(name='PrinceSuffix', phrase_id=prince_song.id)
    screensaver_descriptions = get_or_create_component_type(name='ScreensaverDescription', phrase_id=screensaver.id)
    screensaver_nouns = get_or_create_component_type(name='ScreensaverNoun', phrase_id=screensaver.id)
    ...
    quest_log_parts = get_or_create_component_type(name='QuestLogPart', phrase_id=quest_progress.id)
    quest_log_actions = get_or_create_component_type(name='QuestLogAction', phrase_id=quest_progress.id)
